...
class TestClient(SimpleTestCase):
    ...
    def test_request_ip_address_v6(self):
        ...
        client_info = client.get_client_info(request=request)
        self.assertEqual(client_info.ip_address, "2001:db8:85a3::8a2e:370:7334")
    ...
    def test_request_ip_address_v6_loopback(self):
        ...
        client_info = client.get_client_info(request=request)
        self.assertEqual(client_info.ip_address, "::1")
    ...
    def test_device_name(self):
        ...
        client_info = client.get_client_info(request=request)
        self.assertEqual(client_info.device_name, "test-device")

    def test_device_name_empty(self):
        request = RequestFactory().get(path="/")
        client_info = client.get_client_info(request=request)
        self.assertEqual(client_info.device_name, "")
